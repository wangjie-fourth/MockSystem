...
import org.github.fourth.mocksystem.packages.mockit.coverage.TestRun;
...
import org.github.fourth.mocksystem.packages.mockit.coverage.paths.PerFilePathCoverage;
...
import static org.github.fourth.mocksystem.packages.mockit.coverage.Metrics.*;
...
public final class FileCoverageData implements Serializable {
    ...
    public void addMethod(@Nonnull MethodCoverageData methodData) {
        pathCoverageInfo.addMethod(methodData);
    }
