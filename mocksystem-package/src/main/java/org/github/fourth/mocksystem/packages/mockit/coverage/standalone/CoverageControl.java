...
public final class CoverageControl extends StandardMBean implements CoverageControlMBean {
    ...
    protected String getDescription(@Nonnull MBeanAttributeInfo info) {
        return getDescription("get" + info.getName());
    }
    ...
    public void setOutputDir(@Nonnull String outputDir) {
        modifyConfigurationProperty("outputDir", outputDir);
    }
    ...
    public void setSrcDirs(@Nonnull String srcDirs) {
        modifyConfigurationProperty("srcDirs", srcDirs);
    }
    ...
    public void setClasses(@Nonnull String classes) {
        modifyConfigurationProperty("classes", classes);
    }
    ...
    public void setExcludes(@Nonnull String excludes) {
        modifyConfigurationProperty("excludes", excludes);
    }
