...
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.InstanceFactory.ClassInstanceFactory;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.InstanceFactory.InterfaceInstanceFactory;
import org.github.fourth.mocksystem.packages.mockit.internal.reflection.ConstructorReflection;
import org.github.fourth.mocksystem.packages.mockit.internal.reflection.EmptyProxy.Impl;
...
import static org.github.fourth.mocksystem.packages.mockit.internal.util.GeneratedClasses.getNameForGeneratedClass;
import static org.github.fourth.mocksystem.packages.mockit.internal.util.Utilities.*;
...
class BaseTypeRedefinition {
    ...
    @Nonnull
    private static final Map<Integer, MockedClass> MOCKED_CLASSES = new HashMap<Integer, MockedClass>();
    @Nonnull
    private static final Map<Type, Class<?>> MOCK_IMPLEMENTATIONS = new HashMap<Type, Class<?>>();
    ...
    private Object createMockInterfaceImplementationDirectly(@Nonnull Type interfaceToMock) {
        Class<?> previousMockImplementationClass = MOCK_IMPLEMENTATIONS.get(interfaceToMock);

        if (previousMockImplementationClass == null) {
            generateNewMockImplementationClassForInterface(interfaceToMock);
            MOCK_IMPLEMENTATIONS.put(interfaceToMock, targetClass);
        } else {
    ...
    private Integer redefineClassesFromCache() {
        ...
        MockedClass mockedClass = MOCKED_CLASSES.get(mockedClassId);
    ...
    private void storeRedefinedClassesInCache(@Nonnull Integer mockedClassId) {
        ...
        MOCKED_CLASSES.put(mockedClassId, mockedClass);
    }
