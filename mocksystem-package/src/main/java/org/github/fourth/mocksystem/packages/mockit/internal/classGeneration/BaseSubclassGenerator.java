...
public class BaseSubclassGenerator extends BaseClassModifier {
    ...
    private void generateConstructorDelegatingToSuper(
        ...
        for (org.github.fourth.mocksystem.packages.mockit.external.asm.Type paramType : org.github.fourth.mocksystem.packages.mockit.external.asm.Type.getArgumentTypes(desc)) {
    ...
    private static int getLoadOpcodeForParameterType(int paramType) {
        if (paramType <= org.github.fourth.mocksystem.packages.mockit.external.asm.Type.INT) {
            return ILOAD;
        }

        switch (paramType) {
            case org.github.fourth.mocksystem.packages.mockit.external.asm.Type.FLOAT:
                return FLOAD;
            case org.github.fourth.mocksystem.packages.mockit.external.asm.Type.LONG:
                return LLOAD;
            case org.github.fourth.mocksystem.packages.mockit.external.asm.Type.DOUBLE:
                return DLOAD;
            default:
                return ALOAD;
        }
    ...
    private static class BaseMethodModifier extends ClassVisitor {
        ...
        @Override
        public final FieldVisitor visitField(
                int access, @Nonnull String name, @Nonnull String desc, String signature, Object value) {
            return null;
        }
    }
    ...
    private final class MethodModifierForSuperclass extends BaseMethodModifier {
        ...
        MethodModifierForSuperclass(@Nonnull String className) {
            super(className);
        }
