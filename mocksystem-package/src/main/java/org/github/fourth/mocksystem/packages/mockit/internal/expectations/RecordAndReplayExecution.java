...
import org.github.fourth.mocksystem.packages.mockit.Expectations;
import org.github.fourth.mocksystem.packages.mockit.StrictExpectations;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.invocation.ExpectedInvocation;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.CaptureOfNewInstances;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.DynamicPartialMocking;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.FieldTypeRedefinitions;
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.mocking.TypeRedefinitions;
...
import static org.github.fourth.mocksystem.packages.mockit.internal.util.GeneratedClasses.isGeneratedSubclass;
...
public final class RecordAndReplayExecution {
    ...
    Error getErrorThrown() {
        return failureState.getErrorThrown();
    }

    void setErrorThrown(@Nullable Error error) {
        failureState.setErrorThrown(error);
    }
