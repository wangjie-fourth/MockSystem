...
public final class ParameterNames {
    private static final Map<String, Map<String, String[]>> CLASSES_TO_METHODS_TO_PARAMETERS = new HashMap<>();
    ...
    public static boolean hasNamesForClass(@Nonnull String classDesc) {
        return CLASSES_TO_METHODS_TO_PARAMETERS.containsKey(classDesc);
    }
    ...
    public static void registerName(
        ...
        Map<String, String[]> methodsToParameters = CLASSES_TO_METHODS_TO_PARAMETERS.get(classDesc);

        if (methodsToParameters == null) {
            methodsToParameters = new HashMap<String, String[]>();
            CLASSES_TO_METHODS_TO_PARAMETERS.put(classDesc, methodsToParameters);
        }
