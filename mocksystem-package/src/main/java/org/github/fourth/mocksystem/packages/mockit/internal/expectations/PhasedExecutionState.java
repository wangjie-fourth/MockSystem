...
import org.github.fourth.mocksystem.packages.mockit.internal.expectations.invocation.InvocationArguments;
...
final class PhasedExecutionState {
    @Nonnull
    final List<Expectation> strictExpectations;
    @Nonnull
    final List<Expectation> notStrictExpectations;
    @Nonnull
